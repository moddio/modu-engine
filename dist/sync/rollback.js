...
export function createRollbackManager(localPlayerId, config = {}) {
...
// Player Management
// ============================================
export function addPlayer(manager, playerId) {
 ...
 */
export function addPlayerAtFrame(manager, playerId, joinFrame) {
    manager.players.add(playerId);
 ...
 */
export function clearSnapshotsBefore(manager, frame) {
...
export function removePlayer(manager, playerId) {
...
export function addLocalInput(manager, data) {
...
export function addRemoteInput(manager, frame, playerId, data) {
...
export function getInputsForFrame(manager, frame) {
...
// Snapshot Management
// ============================================
export function saveSnapshot(manager) {
...
export function loadSnapshot(manager, frame) {
...
export function checkRollback(manager) {
...
export function performRollback(manager, toFrame) {
...
export function advanceFrame(manager) {
...
function updateConfirmedFrame(manager) {
    ...
    const startFrame = Math.max(inputBuffer.lastConfirmedFrame + 1, config.inputDelay // First frame that could possibly have inputs
    );
...
export function getInputsToSend(manager) {
...
export function getSyncState(manager) {
    return {
...
// Debugging
// ============================================
export function getRollbackStats(manager) {
    return {
