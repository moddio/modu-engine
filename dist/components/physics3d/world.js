 ...
 */
import { FP_ONE, FP_HALF, toFixed, fpMul, fpDiv, fpAbs, fpSqrt } from '../../math/fixed';
import { vec3Zero, vec3Clone, vec3Add, vec3Scale, vec3LengthSq } from '../../math/vec';
import { quatFromAxisAngle, quatMul, quatNormalize } from '../../math/quat';
import { aabbOverlap } from './shapes';
import { BodyType } from './rigid-body';
import { computeAABB, detectCollision, resolveCollision } from './collision';
import { shouldCollide } from './layers';
import { TriggerState } from './trigger';
// ============================================
// Constants
// ============================================
const GRAVITY = { x: 0, y: toFixed(-30), z: 0 }; // -30 units/s²
...
export function createWorld(dt = 1 / 60) {
    const world = {
        bodies: [],
 ...
 */
export function isGrounded(world, body, threshold = 0.15) {
...
export function stepWorld(world) {
    ...
    const restingContactBodies = new Set();
    const sleepingContactBodies = new Set();
