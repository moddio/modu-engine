 ...
 */
export function createFilter(layer, mask = Layers.ALL) {
    return { layer, mask };
}
/**
 ...
 */
export function shouldCollide(a, b) {
    return (a.mask & b.layer) !== 0 && (b.mask & a.layer) !== 0;
}
/**
 * Create a filter that collides with specific layers
 */
export function filterCollidingWith(layer, ...collidesWithLayers) {
    let mask = 0;
 ...
 */
export function filterExcluding(layer, ...excludeLayers) {
    let mask = Layers.ALL;
